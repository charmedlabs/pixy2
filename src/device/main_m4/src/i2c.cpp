...
I2c::I2c(LPC_I2Cn_Type *i2c, uint8_t addr, SerialTxCallback callback) : m_rq(I2C_RECEIVE_BUF_SIZE), m_tq(I2C_TRANSMIT_BUF_SIZE, callback)
{
	m_i2c = i2c;
...
void i2c_init(SerialTxCallback callback)
{
